...
int main()
{
	...
	magazyn1.tab_Napoje[4] = { 5, "Tymbark - pomarañcza 0,5l", 5, 20 };
	magazyn1.tab_Napoje[5] = { 6, "Tymbark - wiœnia, jab³ko 0,5l", 5, 10 };



	magazyn1.tab_Posilki[0] = { 1, "Pierogi ruskie", 15 };
	magazyn1.tab_Posilki[1] = { 2, "Pierogi z miêsem", 17 };
	magazyn1.tab_Posilki[2] = { 3, "Pierogi z truskawkami", 14 };
	magazyn1.tab_Posilki[3] = { 4, "Naleœniki z serem", 15 };
